...
public class Move : MonoBehaviour {
    ...
    private List<int> winningMoves = new List<int>();
    ...
    private List<int> lastMovesTemp;
    ...
    public void NewGameButtonPressed()
    {
        ...
        {
            for (int i = 0; i < semiPermCubeFace.Length; i++)
            {
        ...
        GameObject[] Front = new GameObject[27];
        GameObject[] Hind = new GameObject[27];
        GameObject[] Top = new GameObject[27];
        GameObject[] Bottom = new GameObject[27];
        GameObject[] Left = new GameObject[27];
        GameObject[] Right = new GameObject[27];

        Front = GameObject.FindGameObjectsWithTag("Front");
        Hind = GameObject.FindGameObjectsWithTag("Hind");
        ...
        {
            foreach (Transform move in child.transform)
            {
                Destroy(move.gameObject);
            }
        }
        foreach (GameObject child in Bottom)
        {
            foreach (Transform move in child.transform)
            {
                Destroy(move.gameObject);
        ...
        foreach (GameObject child in Hind)
        {
            foreach (Transform move in child.transform)
            {
                Destroy(move.gameObject);
        ...
        foreach (GameObject child in Top)
        {
            foreach (Transform move in child.transform)
            {
                Destroy(move.gameObject);
        ...
        foreach (GameObject child in Left)
        {
            foreach (Transform move in child.transform)
            {
                Destroy(move.gameObject);
        ...
        foreach (GameObject child in Right)
        {
            foreach (Transform move in child.transform)
            {
                Destroy(move.gameObject);
            ...
            if (Physics.Raycast(ray, out hit, 20))
            {
                ...
                else if (hit.transform.childCount == 0)
                {
                    if (Input.GetMouseButtonDown(0) && !EventSystem.current.IsPointerOverGameObject())
                    {
                        ...
                        //if (rotate
                        //    //what i should do is do pointing at cube face highlights all on that face, then have something pop 
                        //    //up asking which direction to turn on click, then look for any moves that have the same first two numbers 
                        //    //and apply algorithm. Add an animation and snap back to preserve the numbers/positions of cubes.

                        //    for (int i = 0; i < GameObject.Find("Alpha").transform.childCount; i++)
                        //    {
                        //        if (GameObject.Find("Alpha").transform.GetChild(i).tag == "Front")
                        //        {
                        //            foreach (Transform child in GameObject.Find("Alpha").transform.GetChild(i))
                        //            {
                        //                Destroy(child.gameObject);
                        //            } 
                        //        }
                        ...
                        //    for (int j = 0; j < 54; j++)
                        //    {
                        //        if (movesX[j] % 110 > 0 && movesX[j] % 110 < 10)
                        //        {
                        //            switch (movesX[j] % 110)
                        //            {
                        //                case 1:
                        ...
                        //    for (int j = 0; j < 54; j++)
                        //    {
                        //        if (movesY[j] % 110 > 0 && movesY[j] % 110 < 10)
                        //        {
                        //            switch (movesY[j] % 110)
                        //            {
                        //                case 1:
                        //                    movesY[j] = 113;
                        //                    RotateMove(113, false);
                        //                    break;
                        //                case 2:
                        //                    movesY[j] = 116;
                        //                    RotateMove(116, false);
                        //                    break;
                        //                case 3:
                        //                    movesY[j] = 119;
                        //                    RotateMove(119, false);
                        //                    break;
                        //                case 4:
                        //                    movesY[j] = 112;
                        //                    RotateMove(112, false);
                        //                    break;
                        //                case 5:
                        //                    movesY[j] = 115;
                        //                    RotateMove(115, false);
                        //                    break;
                        //                case 6:
                        //                    movesY[j] = 118;
                        //                    RotateMove(118, false);
                        //                    break;
                        //                case 7:
                        //                    movesY[j] = 111;
                        //                    RotateMove(111, false);
                        //                    break;
                        //                case 8:
                        //                    movesY[j] = 114;
                        //                    RotateMove(114, false);
                        //                    break;
                        //                case 9:
                        //                    movesY[j] = 117;
                        //                    RotateMove(117, false);
                        //                    break;
                        //            }
                        //        }
                        //    }
        ...
        for (int i = 0; i < 9; i++)
        {
            ...
            if (childHelper[i] != null && childHelper[i] != "")
            {
                ...
                if (hit.collider.gameObject.tag == "Clockwise")
                {
                    ...
                    ClockwiseRotation(partOfFace, i, obj, hit);
                }
                else if (hit.collider.gameObject.tag == "Counter Clockwise")
                {
                    CounterClockwiseRotation(partOfFace, i, obj, hit);
                    for (int j = 0; j < 9; j++)
                    {
                        rend = GameObject.Find(cubeface[j]).GetComponent<Renderer>();
    ...
    private void CounterClockwiseRotation(int partOfFace, int i, GameObject obj, RaycastHit hit)
    {
        switch (partOfFace)
        {
            case 1:
    ...
    private void ClockwiseRotation(int partOfFace, int i, GameObject obj, RaycastHit hit)
    {
        switch (partOfFace)
        {
            case 1:
